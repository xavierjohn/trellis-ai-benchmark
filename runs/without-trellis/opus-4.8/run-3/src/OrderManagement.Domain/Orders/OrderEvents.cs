...
public sealed record OrderSubmittedEvent(Guid OrderId, Guid CustomerId, decimal OrderTotal, DateTimeOffset SubmittedAt) : IDomainEvent
{
...
public sealed record OrderCancelledEvent(Guid OrderId, OrderStatus CancelledFromStatus, DateTimeOffset CancelledAt) : IDomainEvent
{
