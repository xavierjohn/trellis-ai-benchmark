...
public class DeliverOrderHandler
{
    ...
    public DeliverOrderHandler(IOrderRepository orderRepository)
    {
    ...
    {
        if (!actor.HasPermission("orders:deliver"))
        {
            return Result<Order>.Forbidden("You do not have permission to deliver orders.");
        }
